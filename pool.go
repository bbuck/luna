...
// EnginePoolKey is the key used in the engine Meta field to store which Pool
// this engine came from (used to put the engine back in the pool when
// not in use.
